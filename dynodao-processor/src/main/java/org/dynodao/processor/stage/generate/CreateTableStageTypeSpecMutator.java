...
import static org.dynodao.processor.util.DynamoDbUtil.attributeDefinition;
import static org.dynodao.processor.util.DynamoDbUtil.createTableRequest;
import static org.dynodao.processor.util.DynamoDbUtil.globalSecondaryIndex;
import static org.dynodao.processor.util.DynamoDbUtil.keySchemaElement;
import static org.dynodao.processor.util.DynamoDbUtil.keyType;
import static org.dynodao.processor.util.DynamoDbUtil.localSecondaryIndex;
import static org.dynodao.processor.util.DynamoDbUtil.projection;
import static org.dynodao.processor.util.DynamoDbUtil.projectionType;
import static org.dynodao.processor.util.DynamoDbUtil.provisionedThroughput;
import static org.dynodao.processor.util.DynamoDbUtil.scalarAttributeType;
import static org.dynodao.processor.util.StreamUtil.concat;
import static org.dynodao.processor.util.StringUtil.repeat;
import static org.dynodao.processor.util.StringUtil.toClassCase;
import static org.dynodao.processor.util.StringUtil.uncapitalize;
