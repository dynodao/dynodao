...
import com.github.dynodao.processor.schema.attribute.DynamoAttributeType;
...
public class AttributeValueSource {
    ...
    @MethodSource("com.github.dynodao.processor.test.params.AttributeValueSource#attributeValuesWithoutBinarySource")
    ...
    @Target({ ElementType.ANNOTATION_TYPE, ElementType.METHOD })
    @Retention(RetentionPolicy.RUNTIME)
    @MethodSource("com.github.dynodao.processor.test.params.AttributeValueSource#attributeValuesWithoutBinarySetSource")
    ...
    @Target({ ElementType.ANNOTATION_TYPE, ElementType.METHOD })
    @Retention(RetentionPolicy.RUNTIME)
    @MethodSource("com.github.dynodao.processor.test.params.AttributeValueSource#attributeValuesWithoutBooleanSource")
    ...
    @Target({ ElementType.ANNOTATION_TYPE, ElementType.METHOD })
    @Retention(RetentionPolicy.RUNTIME)
    @MethodSource("com.github.dynodao.processor.test.params.AttributeValueSource#attributeValuesWithoutListSource")
    ...
    @Target({ ElementType.ANNOTATION_TYPE, ElementType.METHOD })
    @Retention(RetentionPolicy.RUNTIME)
    @MethodSource("com.github.dynodao.processor.test.params.AttributeValueSource#attributeValuesWithoutMapSource")
    ...
    @Target({ ElementType.ANNOTATION_TYPE, ElementType.METHOD })
    @Retention(RetentionPolicy.RUNTIME)
    @MethodSource("com.github.dynodao.processor.test.params.AttributeValueSource#attributeValuesWithoutNullSource")
    ...
    @Target({ ElementType.ANNOTATION_TYPE, ElementType.METHOD })
    @Retention(RetentionPolicy.RUNTIME)
    @MethodSource("com.github.dynodao.processor.test.params.AttributeValueSource#attributeValuesWithoutNumberSource")
    ...
    @Target({ ElementType.ANNOTATION_TYPE, ElementType.METHOD })
    @Retention(RetentionPolicy.RUNTIME)
    @MethodSource("com.github.dynodao.processor.test.params.AttributeValueSource#attributeValuesWithoutNumberSetSource")
    ...
    @Target({ ElementType.ANNOTATION_TYPE, ElementType.METHOD })
    @Retention(RetentionPolicy.RUNTIME)
    @MethodSource("com.github.dynodao.processor.test.params.AttributeValueSource#attributeValuesWithoutStringSource")
    ...
    @Target({ ElementType.ANNOTATION_TYPE, ElementType.METHOD })
    @Retention(RetentionPolicy.RUNTIME)
    @MethodSource("com.github.dynodao.processor.test.params.AttributeValueSource#attributeValuesWithoutStringSetSource")
