...
class StringDynamoAttributeTest extends AbstractUnitTest {
    ...
    private StringDynamoAttribute createInstance() {
    ...
    void accept_noArg_invokesVisitStringWithNull() {
        ...
        verify(dynamoAttributeVisitorMock).visitString(classUnderTest, null);
    ...
    void accept_withArg_invokesVisitString() {
        ...
        assertThat(accept).isEqualTo(VISITOR_RETURN);
        verify(dynamoAttributeVisitorMock).visitString(classUnderTest, VISITOR_ARG);
        verifyNoMoreInteractions(dynamoAttributeVisitorMock);
    }
