...
public class MapDynamoAttributeTest extends AbstractUnitTest {
    ...
    @Test
    public void accept_noArg_invokesVisitMapWithNull() {
    ...
    @Test
    public void accept_withArg_invokesVisitMap() {
        MapDynamoAttribute classUnderTest = createInstance();
