...
public class ListDynamoAttributeTest extends AbstractUnitTest {
    ...
    @Test
    public void getAttributeType_onlyUseCase_returnsList() {
        assertThat(createInstance().getAttributeType()).isEqualTo(DynamoAttributeType.LIST);
    }

    @Test
    public void accept_noArg_invokesVisitListWithNull() {
    ...
    @Test
    public void accept_withArg_invokesVisitList() {
        ListDynamoAttribute classUnderTest = createInstance();
